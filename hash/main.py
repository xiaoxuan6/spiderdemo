...
def init():
    resp = requests.get(
        'https://www.spiderdemo.cn/authentication/api/hash_challenge/init/?challenge_type=hash_challenge',
...
def load_data(count):
    ...
    for page in range(2, 101):
        ...
        headers.update({
            'x-request-token': result['x_token'],
            'x-verify-code': result['x_code']
        })
        resp = requests.get(f'https://www.spiderdemo.cn/authentication/api/hash_challenge/page/{page}/',
